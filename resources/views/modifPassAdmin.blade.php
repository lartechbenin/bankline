                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4" x-data="{
                            ...
                            <form method="post" action="{{route('modifierPassAdmin')}}">
                               @csrf
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">MOT DE PASSE ACTUEL</label>
                                    <div class="col-sm-10">
                                        <input x-bind:type="type" class="form-control" value="" id="inputPassword3" name="current_password">
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input  x-bind:type="type" value="" class="form-control" id="inputPassword2" name="password_confirmation" >
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input x-bind:type="type" value="" class="form-control" id="inputPassword1" name="password">
                                    </div>
                                    @error('password')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
