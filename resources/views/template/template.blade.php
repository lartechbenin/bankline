...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <script src="https://cdn.jsdelivr.net/gh/kevinbatdorf/alpine-auto-interval@0.2.1/dist/index.js"></script>
    <script defer src="https://unpkg.com/alpinejs@3.1.1/dist/cdn.min.js"></script>
    
</head>

<body onload="increments('{{Auth::user()->pourcentage}}', '{{Auth::user()->pourcentage_max}}')">
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 p-3">
            <nav class="navbar bg-light navbar-light">
                <a href="{{route('compte')}}" class="navbar-brand mx-4 mb-3">
                 <marquee>   <h3 class="text-primary"><i ></i>{{config('app.name')}}</h3></marquee>
                </a>
                ...
                <div class="navbar-nav w-100">
                    <a href="{{route('compte')}}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Accueil</a>
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="{{route('editer')}}" class="dropdown-item">EDITE PROFILE</a>
                        </div>
                    </div>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                <a href="{{route('compte')}}" class="navbar-brand d-flex d-lg-none me-4">
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">{{config('app.name')}}</a>, Tous les droits réserver. 
                        </div>
