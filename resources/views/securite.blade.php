                        ...
                        <div class="bg-light rounded h-100 p-4">
                            <form>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">RETAPER NOUVEAU MOT DE PASSE</label>
                                    <div class="col-sm-10">
                                        <input type="password" class="form-control" id="inputPassword3">
                                    </div>
                                </div>
                                ...
                                <label class="form-check-label" for="flexSwitchCheckDefault">Afficher mot de passe
                                    Afficher</label>
                            </div>
